...
register(ToolSpec(
    name="search_assets",
    description="Search the text of ingested documents.",
    parameters={
...
register(ToolSpec(
    ...
    description=("Recall what this conversation has already established — "
                 "decisions taken, entities and files discussed. Use for "
...
register(ToolSpec(
    ...
    description="Create a versioned workspace for generated work (code, docs, apps).",
    parameters={
...
register(ToolSpec(
    ...
    description="Edit a workspace. Send only the files you are changing — the rest carry forward.",
    parameters={
